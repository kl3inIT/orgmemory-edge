# Build Week foundation plan

- [x] Official Tauri 2 React/TypeScript scaffold
- [x] Pilot capture/review/SOP interface
- [x] Admin device-health boundary
- [x] Rust state and JSON export commands
